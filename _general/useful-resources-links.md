...
- [BLU Set Builder](https://partywormxi.github.io/buildablu/) - Website that lets you see job traits/stat bonuses as you build out your BLU sets.  Generates XML to put into your azuresets (Windower addon) `settings.xml` file.  
### Tools
